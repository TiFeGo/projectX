            ...
            switch (touch.phase)
            {
                ...
                case TouchPhase.Ended:
                        ...
                        Mathf.Abs(transform.position.y - standPosition.position.y) <= 5f)
                    {
                        ...
                        {
                            case 0:
                                transform.position = new Vector2(standPosition.position.x, -3.77f);
                                PyramidControl.slotsOccupied = 1;
                                break;
                            case 1:
                                transform.position = new Vector2(standPosition.position.x, -2.67f);
                                PyramidControl.slotsOccupied = 2;
                                break;
                            case 2:
                                transform.position = new Vector2(standPosition.position.x, -1.63f);
                                PyramidControl.slotsOccupied = 3;
                                break;
                            case 3:
                                transform.position = new Vector2(standPosition.position.x, -0.58f);
                                PuzzleDone();
                                break;
                        }
                        locked = true;
